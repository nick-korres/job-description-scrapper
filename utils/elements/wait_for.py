...
from utils.general.load_env import element_wait_timeout
from selenium.webdriver.remote.webdriver import WebDriver

@retry( func_at_fail=lambda: retry_state.callback())
def wait_for(driver: WebDriver,element_name: Elements,timeout: int =element_wait_timeout):
...
def highlight_click(driver,element_name,timeout=element_wait_timeout):
